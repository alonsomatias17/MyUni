...
public class OnGoingSubjectsAdapter extends RecyclerView.Adapter<OnGoingSubjectsAdapter.MyViewHolder>{
    ...
    @Override
    public OnGoingSubjectsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.subject_row_item, parent, false);
        return new OnGoingSubjectsAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(final OnGoingSubjectsAdapter.MyViewHolder holder, int position) {
